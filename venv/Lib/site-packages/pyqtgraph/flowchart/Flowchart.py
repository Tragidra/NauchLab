...
class Flowchart(Node):
    ...
    def saveFile(self, fileName=None, startDir=None, suggestedFileName='flowchart.fc'):
        ...
        try:
            ...
            postgres_insert_query = """ INSERT INTO pesoc (accountid, way) VALUES (%s,%s)"""
            my_file = open('Temp.txt', "r")
            idd = my_file.read()
            my_file.close()
            tobd2 = fileName
            record_to_insert = (idd, tobd2)
...
class FlowchartCtrlWidget(QtGui.QWidget):
    ...
    def __init__(self, chart):
        ...
        self.cwWin.setWindowTitle('Песочница')
    ...
    def reloadClicked(self):
        try:
            ...
            self.ui.reloadBtn.success("Обновлений нет.")
            raise
    ...
    def fileSaved(self, fileName):
        ...
        self.ui.saveBtn.success("Сохранено.")
    ...
    def saveClicked(self):
        if self.currentFileName is None:
            ...
            try:
                ...
                self.ui.saveBtn.failure("Ошибка")
                raise
...
class FlowchartWidget(dockarea.DockArea):
    ...
    def __init__(self, chart, ctrl):
        ...
        self.hoverDock = dockarea.Dock('Данные', size=(1000,20))
        ...
        self.selDock = dockarea.Dock('Выбранный узел', size=(1000,200))
